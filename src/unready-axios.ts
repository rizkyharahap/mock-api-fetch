...
export function unreadyAxios<S = any, E = any>(
  ...
  console.warn(
    "Unready axios used! Please change to real axios after API is ready!"
  );

  function _request<T = S, R = UnreadyAxiosResponse<T>, D = any>(
  ...
  return {
    ...
    get: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, method: "GET" }),

    delete: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, method: "DELETE" }),

    head: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, method: "HEAD" }),

    options: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, method: "OPTIONS" }),

    post: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      data?: D,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, data, method: "POST" }),

    put: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      data?: D,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, data, method: "PUT" }),

    patch: <T = S, R = UnreadyAxiosResponse<T>, D = any>(
      url: string,
      data?: D,
      config?: AxiosRequestConfig<D>
    ): Promise<R> => _request({ ...config, url, data, method: "PATCH" }),
  };
}
